...
export default function PublicShopPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-emerald-50/30 p-4 md:p-8">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/20 to-teal-50/30">
      ...
      {/* Contact Modal - prompts login/register */}
      {showContactModal && (
      ...
      <div className="text-center py-6 text-xs text-muted-foreground border-t">
        Boutique hébergée sur EcoRDC • Copyright © {new Date().getFullYear()}
      </div>
    </div>
  );
}
